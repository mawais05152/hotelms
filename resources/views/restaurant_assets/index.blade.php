            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <h4>Restaurant Assets</h4>
                        <button class="btn btn-success mt-1" data-bs-toggle="modal" data-bs-target="#addModal">+ Add Asset</button>
                    </div>
                    <div class="card-body">
                        @if (session('success'))
                                ...
                                @foreach ($assets as $asset)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('restaurant-assets.destroy', $asset->id) }}" method="POST" class="d-inline">
                                                @csrf @method('DELETE')
                                                <button class="btn btn-sm btn-danger" onclick="return confirm('Delete this asset?')">Delete</button>
                                            </form>
                                        </td>
                                    </tr>
