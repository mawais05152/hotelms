                            ...
                            <tbody>
                                @foreach ($assets as $purchase)
                                    <tr>
                                        ...
                                        <td>
                                            {{ optional($purchase->variation)->unit ?? 'Not Found' }}
                                            {{ optional($purchase->variation)->size ?? '' }}
                                        </td>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                <label for="name">Asset Name</label>
                                                                 <input type="text" name="name" value="{{ $purchase->name }}" class="form-control" placeholder="Name" required>
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                                <label for="asset_type">Asset Type</label>
                                                                <input type="text" name="asset_type" value="{{ $purchase->asset_type }}" class="form-control" placeholder="Type" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                 ...
                                                                 <input type="number" name="total_quantity" class="form-control" placeholder="Quantity" required>
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                                <label for="price">Price</label>
                                                                 <input type="number" name="price"  value="{{ $purchase->price }}" class="form-control" placeholder="Price">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                 ...
                                                                 <input type="text" name="supplier_name" value="{{ $purchase->supplier_name }}"  class="form-control" placeholder="Supplier" required>
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                                 <label for="warehouse_name">Warehouse Name</label>
                                                                 <input type="text" name="warehouse_name" value="{{ $purchase->warehouse_name }}" class="form-control" placeholder="Warehouse" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                 <label for="notes">Notes</label> <textarea name="notes" class="form-control" placeholder="Notes">{{ $purchase->notes }}</textarea>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" name="additional_qty" id="additional_qty" class="form-control" required>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="supplier_name">Supplier Name</label>
                                                            <input type="text" name="supplier_name" id="supplier_name" class="form-control" placeholder="Supplier" required>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="warehouse_name">Warehouse Name</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="supplier_name">Supplier Name</label>
                                <input type="text" name="supplier_name" class="form-control" placeholder="Name" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="invoice_no">invoice_no</label>
                                <input type="number" name="invoice_no" class="form-control" placeholder="Main invoice_no">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="purchase_date">Purchase Date</label>
                                <input type="date" name="purchase_date" value="{{ old('purchase_date', \Carbon\Carbon::now()->toDateString()) }}" class="form-control" required readonly>
                            </div>
                            <div class="col-md-6 mb-3">
