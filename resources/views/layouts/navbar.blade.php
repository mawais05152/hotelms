              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                ...
                <li class="nav-item topbar-icon dropdown hidden-caret">
                  ...
                  >
                          ...
                          @if(Auth::check())
                            @forelse(Auth::user()->unreadNotifications as $notification)
                              <a href="{{ route('orders.show', $notification->data['order_id']) }}" class="dropdown-item">
                                ...
                                <div class="notif-content">
                                  <span class="block fw-bold" style="font-size: 13px;">
                                    {{ $notification->data['message'] }}
                                  </span>
                                  <span class="block small text-muted">
                                    User: {{ $notification->data['user_name'] }} | Price: ${{ $notification->data['price'] }}
                                  </span>
                    ...
                    <li>
                      <a class="see-all" href="{{ route('orders.index') }}"
                    ...
                    <div class="dropdown-user-scroll scrollbar-outer">
                      <li>
                        <div class="user-box">
                          ...
                          <div class="u-text">
                            <h4>{{Auth::check() ? Auth::user()->name : 'User'}}</h4>
